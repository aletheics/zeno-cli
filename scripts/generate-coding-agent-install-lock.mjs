...
const internalPackagePrefix = "@aletheics/zeno-";
const internalPackageNames = new Set(["@aletheics/chord"]);
const installPackageName = "@aletheics/zeno-coding-agent-install";
