...
const WORKSPACE = {
	"@aletheics/chord": "packages/chord/src",
	"@aletheics/zeno-ai": "packages/ai/src",
	"@aletheics/zeno-agent-core": "packages/agent/src",
	"@aletheics/zeno-telemetry": "packages/telemetry/src",
	"@aletheics/zeno-tui": "packages/tui/src",
};
