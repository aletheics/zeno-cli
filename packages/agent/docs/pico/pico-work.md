...
- `@aletheics/chord` Context types and `@aletheics/chord/context` helpers (1, 6, 8, 19)
- `@aletheics/chord/delta` (15, 16: preview/watch only; not storage)
- `@aletheics/zeno-ai`: `faux` provider for tests, `utils/estimate` for thresholds; SystemMessage and
