...
export default defineConfig({
	...
	resolve: {
		conditions: ["source"],
		alias: [
			{ find: /^@aletheics\/zeno-telemetry$/, replacement: telemetryIndex },
			{ find: /^@aletheics\/zeno-agent-core\/node$/, replacement: agentNode },
			{ find: /^@aletheics\/zeno-agent-core\/harness\/session\/testing$/, replacement: agentSessionTesting },
			{ find: /^@aletheics\/zeno-agent-core$/, replacement: agentIndex },
			{ find: /^@aletheics\/zeno-ai$/, replacement: aiIndex },
		],
	},
