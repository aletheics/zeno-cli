# @aletheics/zeno-client

Transport-neutral client for the experimental Zeno service protocol.

```ts
import { Client, type ByteTransportFactory } from "@aletheics/zeno-client";
...
```ts
import { Client } from "@aletheics/zeno-client";
...
```ts
import { discoverUnixServers } from "@aletheics/zeno-client/unix";
