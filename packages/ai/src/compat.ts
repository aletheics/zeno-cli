 ...
 *
 * Existing apps switch imports from "@aletheics/zeno-ai" to
 * "@aletheics/zeno-ai/compat" unchanged; new code uses `createModels()`
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@aletheics/zeno-ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@aletheics/zeno-ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@aletheics/zeno-ai/providers/all" or `Models.getProviders()`. */
