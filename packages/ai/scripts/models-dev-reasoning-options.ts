...
/**
 * Converts models.dev verified effort values into Zeno's selectable thinking levels.
 * Values without a Zeno equivalent (`default` and JSON `null`) are intentionally
 * omitted.
 */
