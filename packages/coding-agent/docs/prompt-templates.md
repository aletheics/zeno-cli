> zeno can create prompt templates. Ask it to build one for your workflow.
...
Zeno loads prompt templates from:

- Global: `~/.zeno/agent/prompts/*.md`
- Project: `.zeno/prompts/*.md` (only after the project is trusted)
