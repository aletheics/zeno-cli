import { ProcessTerminal, setCapabilityOverrides, setKeybindings, type TUI, TuiMainScreen } from "@aletheics/zeno-tui";
...
const OFFICIAL_PACKAGE_NAME = "@aletheics/zeno-coding-agent";
const OFFICIAL_APP_NAME = "zeno";
const OFFICIAL_CONFIG_DIR_NAME = ".zeno";
 ...
 * - this is the official Zeno distribution (not a fork/rebrand)
