...
import { Client, ServerError } from "@aletheics/zeno-client";
import { createUnixTransportFactory, discoverUnixServers, type UnixServerRoute } from "@aletheics/zeno-client/unix";
...
export interface OpenClientRuntimeOptions {
	/** Directory searched when --connect is omitted. Defaults to PI_SERVER_DIR or ~/.zeno/server. */
