...
import * as _bundledPiAgentCore from "@aletheics/zeno-agent-core";
import type { Provider } from "@aletheics/zeno-ai";
import * as _bundledPiAiCompat from "@aletheics/zeno-ai/compat";
import * as _bundledPiAiOauth from "@aletheics/zeno-ai/oauth";
import * as _bundledPiAiProviders from "@aletheics/zeno-ai/providers/all";
import type { KeyId } from "@aletheics/zeno-tui";
import * as _bundledPiTui from "@aletheics/zeno-tui";
...
const VIRTUAL_MODULES: Record<string, unknown> = {
	...
	"@aletheics/zeno-agent-core": _bundledPiAgentCore,
	"@aletheics/zeno-tui": _bundledPiTui,
	// Extensions resolve the pi-ai root to the compat entrypoint (a strict
	// superset of the core entrypoint): existing extensions using the old
	// global API keep working at runtime until compat is removed.
	"@aletheics/zeno-ai": _bundledPiAiCompat,
...
function getAliases(): Record<string, string> {
	...
	// superset of the core entrypoint): existing extensions using the old
	// global API keep working at runtime until compat is removed.
	const piAiCompatEntry = resolveWorkspaceOrImport("ai/dist/compat.js", "@aletheics/zeno-ai/compat");
	const piAiOauthEntry = resolveWorkspaceOrImport("ai/dist/oauth.js", "@aletheics/zeno-ai/oauth");
