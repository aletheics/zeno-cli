...
import { Agent, type AgentMessage, setDefaultStreamFn, type ThinkingLevel } from "@aletheics/zeno-agent-core";
import { clampThinkingLevel, type Message, type Model, streamSimple } from "@aletheics/zeno-ai/compat";
