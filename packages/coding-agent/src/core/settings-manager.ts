import type { ThinkingLevel } from "@aletheics/zeno-agent-core";
import { DEFAULT_MAX_AGENT_RETRY_DELAY_MS, type Model, type Transport } from "@aletheics/zeno-ai";
import type { TuiMode as RendererTuiMode, ScrollViewScrollbar, TerminalCapabilities } from "@aletheics/zeno-tui";
...
export interface Settings {
	...
	httpProxy?: string; // Proxy URL applied as HTTP_PROXY and HTTPS_PROXY for Zeno-managed HTTP clients
