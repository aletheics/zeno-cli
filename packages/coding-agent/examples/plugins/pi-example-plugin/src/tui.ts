import { defineFacet } from "@aletheics/chord";
import { AgentController, PresentationUI, SlashCommands } from "@aletheics/zeno-coding-agent/experimental/plugin";
import { ExampleFacetService } from "./contract.ts";

export default defineFacet({
	id: "@aletheics/zeno-example-plugin/tui",
	setup(env) {
