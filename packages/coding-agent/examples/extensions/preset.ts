 ...
 * - ~/.zeno/agent/presets.json (global)
 * - <cwd>/.zeno/presets.json (project-local)
 *
 ...
 *
 * Usage:
 * - `zeno --preset plan` - start with plan preset
...
import type { Api, Model } from "@aletheics/zeno-ai";
import type { ExtensionAPI, ExtensionContext } from "@aletheics/zeno-coding-agent";
import { CONFIG_DIR_NAME, DynamicBorder, getAgentDir } from "@aletheics/zeno-coding-agent";
import { Container, Key, type SelectItem, SelectList, Text } from "@aletheics/zeno-tui";
