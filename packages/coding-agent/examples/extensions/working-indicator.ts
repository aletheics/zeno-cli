 ...
 * working indicator shown while zeno is streaming a response.
 *
 * Usage:
 *   zeno --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore zeno's default spinner
 */

import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "@aletheics/zeno-coding-agent";
