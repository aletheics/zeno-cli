 ...
 * (logo + keybinding hints) with a custom component showing the zeno mascot.
 */

import type { ExtensionAPI, Theme } from "@aletheics/zeno-coding-agent";
import { VERSION } from "@aletheics/zeno-coding-agent";

// --- PI MASCOT ---
// Based on pi_mascot.ts - the zeno agent character
