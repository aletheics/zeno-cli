 ...
 * Demonstrates how extensions can use ctx.shutdown() to exit zeno cleanly.
 */
...
export default function (pi: ExtensionAPI) {
	// Register a /quit command that cleanly exits zeno
	pi.registerCommand("quit", {
		description: "Exit zeno cleanly",
	...
	pi.registerTool({
		...
		description: "Complete a task and exit zeno",
	...
	pi.registerTool({
		...
		description: "Deploy the application and exit zeno",
		parameters: Type.Object({
