...
import type { OAuthCredentials } from "@aletheics/zeno-ai";
import { getModel, streamSimple } from "@aletheics/zeno-ai/compat";
import { builtinProviders } from "@aletheics/zeno-ai/providers/all";
...
const AUTH_PATH = join(homedir(), ".zeno", "agent", "auth.json");
...
export const PI_AGENT_DIR = join(homedir(), ".zeno", "agent");
