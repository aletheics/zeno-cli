import type { Component, Terminal, TUI } from "@aletheics/zeno-tui";
import { Container, getKeybindings, isViewportTUI, ScrollView, setKeybindings, Text } from "@aletheics/zeno-tui";
