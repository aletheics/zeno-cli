...
import { Text, type TUI, type TuiMouseEvent } from "@aletheics/zeno-tui";
...
describe("ToolExecutionComponent parity", () => {
	...
	for (const scenario of [
		...
		{
			title: "AGENTS.md",
			path: join(process.cwd(), ".zeno", "AGENTS.md"),
			content: "Hidden resource instructions",
			compact: "read resource .zeno/AGENTS.md",
			hidden: "Hidden resource instructions",
			absent: undefined,
		},
		{
			title: "AGENTS.override.md",
			path: join(process.cwd(), ".zeno", "AGENTS.override.md"),
			content: "Hidden override instructions",
			compact: "read resource .zeno/AGENTS.override.md",
