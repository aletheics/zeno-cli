...
import type { AssistantMessage, Context, Model } from "@aletheics/zeno-ai";
...
vi.mock("@aletheics/zeno-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@aletheics/zeno-ai/compat")>();
	return {
		...actual,
