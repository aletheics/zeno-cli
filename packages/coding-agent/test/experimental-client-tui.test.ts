...
import { ProcessTerminal, TuiMainScreen } from "@aletheics/zeno-tui";
		...
		async (kind, command, sessionId, creates) => {
			...
			const reloadArtifact: FacetBundleArtifact = {
				...
				entry: {
					...
					externalImports: ["@aletheics/chord"],
				},
				source: reloadSource,
			};
