...
Multiple zeno sessions may be running in this cwd at the same time, each modifying different files. Git operations that touch unstaged, staged, or untracked files outside your own changes will stomp on other sessions' work. Follow these rules:
...
For testing zeno's interactive mode, load and follow [.zeno/skills/interactive-testing.md](.zeno/skills/interactive-testing.md).
...
For release preparation, publishing, verification, or recovery, load and follow [.zeno/skills/release.md](.zeno/skills/release.md).
